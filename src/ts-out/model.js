    ...
    getRockets() {
        this.rockets.forEach((rocket) => {
            ...
            rocket.thrusters.forEach((thruster) => {
                console.log(`Rocket ${rocket.id}'s thruster ${thruster.thrusterId}'s maxpower of  is ${thruster.thrusterMaxPower} and its current speed is ${thruster.thrusterSpeed}`);
            });
        });
    }

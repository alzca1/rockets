class View {
    ...
    rocketForm: HTMLElement;
    idInput: HTMLElement;
    small: HTMLElement;
    addRocketButton: HTMLElement;
    thrusterForm: HTMLElement;
    thrusterMaxPowerInput: HTMLElement;
    addThrusterButton: HTMLElement;
    rocketList: HTMLElement;
    ...
    get _getIdText(): string {
      const inputValue: string = this.idInput.value;
      return inputValue;
    }
    ...
    get _getThrusterPower(): number | boolean {
      const maxPowerInput: number = parseInt(this.thrusterMaxPowerInput.value);
    ...
    _resetThrusterPower(): void {
      this.thrusterMaxPowerInput.value = "";
    }
  
    createElement(tag: string, className?, ...args: any): HTMLElement {
    ...
    bindAddRocketForm(handler):(void | boolean) {
    ...
    bindCreateThrusterForm(button, element):void {
    ...
    bindAddThrusterForm(handler):(void |boolean) {
    ...
    bindIncreaseRocketSpeed(handler):void {
    ...
    bindDecreaseRocketSpeed(handler): void {
      this.rocketList.addEventListener("click", (event) => {
    ...
    bindIncreaseThrusterSpeed(handler):void {
      this.rocketList.addEventListener("click", (event) => {
    ...
    bindDecreaseThrusterSpeed(handler):void {
      this.rocketList.addEventListener("click", (event) => {
